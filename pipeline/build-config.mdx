---
title: "Configure Builds with build-config.yml"
sidebarTitle: "Build Config"
description: "build-config.yml controls Java version, Maven version, build tool, test settings, SonarQube, Nexus, app server targets, security scanning, and versioning for every pipeline run."
---
