---
title: "Security Scanning: Detecting Hardcoded Secrets in Code"
sidebarTitle: "Security Scanning"
description: "The enhanced pipeline scans src/ for hardcoded passwords, API keys, and tokens using grep. The build fails immediately if any secrets are detected."
---
