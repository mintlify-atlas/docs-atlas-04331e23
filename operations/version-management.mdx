...
description: "Every pipeline build gets a unique version in BUILD_NUMBER-TIMESTAMP format. Version metadata is embedded in WAR files and versioned configuration archives are stored in Nexus."
---
