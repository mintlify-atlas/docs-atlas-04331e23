...
description: "Migrate Java EE apps to Jakarta EE on WildFly: update pom.xml dependencies, replace javax imports, run parallel JBoss and WildFly instances, then cut over."
---
