---
title: "Automated Backup and Restore for the CI/CD Environment"
sidebarTitle: "Backup & Restore"
description: "backup-restore.sh creates timestamped archives of environment configs, Jenkins jobs, Nexus, SonarQube database, WildFly/JBoss configs, and build files."
---
...
- **Jenkins jobs** — `jenkins-jobs.tar.gz` is copied into the Jenkins container, extracted with `tar xzf`, and the container is restarted with `docker restart jenkins`
