...
description: "Jenkins runs on port 8080, auto-configured on first boot via init.groovy.d scripts with plugins, Maven 3.9.2, SonarQube server, and Nexus credentials."
---
