...
description: "SonarQube runs on port 9000 with a PostgreSQL backend. It performs code quality analysis, security vulnerability detection, and enforces Quality Gates in the pipeline."
---
