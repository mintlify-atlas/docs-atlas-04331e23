...
description: "Use docker-compose.override.yml to pin image versions, increase JVM heap sizes, add CPU/memory limits, configure health checks, and tune PostgreSQL for production."
---
